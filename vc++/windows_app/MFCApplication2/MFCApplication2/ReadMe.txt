...
MFCApplication2Dlg.h, MFCApplication2Dlg.cpp - the dialog
    These files contain your CMFCApplication2Dlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in MFCApplication2.rc, which can be edited in Microsoft Visual C++.
